...
sys_env_destroy(envid_t envid)
{
  ...
  800131:	68 4a 10 80 00       	push   $0x80104a
  800136:	6a 23                	push   $0x23
  800138:	68 67 10 80 00       	push   $0x801067
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001be:	68 4a 10 80 00       	push   $0x80104a
  8001c3:	6a 23                	push   $0x23
  8001c5:	68 67 10 80 00       	push   $0x801067
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800204:	68 4a 10 80 00       	push   $0x80104a
  800209:	6a 23                	push   $0x23
  80020b:	68 67 10 80 00       	push   $0x801067
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80024a:	68 4a 10 80 00       	push   $0x80104a
  80024f:	6a 23                	push   $0x23
  800251:	68 67 10 80 00       	push   $0x801067
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800290:	68 4a 10 80 00       	push   $0x80104a
  800295:	6a 23                	push   $0x23
  800297:	68 67 10 80 00       	push   $0x801067
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d6:	68 4a 10 80 00       	push   $0x80104a
  8002db:	6a 23                	push   $0x23
  8002dd:	68 67 10 80 00       	push   $0x801067
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80031c:	68 4a 10 80 00       	push   $0x80104a
  800321:	6a 23                	push   $0x23
  800323:	68 67 10 80 00       	push   $0x801067
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800398:	56                   	push   %esi
  800399:	50                   	push   %eax
  80039a:	68 78 10 80 00       	push   $0x801078
  ...
  8003ab:	e8 5a 00 00 00       	call   80040a <vcprintf>
	cprintf("\n");
  8003b0:	c7 04 24 9b 10 80 00 	movl   $0x80109b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80050b:	0f be 80 9d 10 80 00 	movsbl 0x80109d(%eax),%eax
  800512:	50                   	push   %eax
...
00800562 <vprintfmt>:
{
  ...
  80068a:	52                   	push   %edx
  80068b:	68 be 10 80 00       	push   $0x8010be
  800690:	53                   	push   %ebx
  800691:	56                   	push   %esi
  ...
  8006a2:	50                   	push   %eax
  8006a3:	68 b5 10 80 00       	push   $0x8010b5
  8006a8:	53                   	push   %ebx
  8006a9:	56                   	push   %esi
  ...
  8006ca:	b8 ae 10 80 00       	mov    $0x8010ae,%eax
