...
sys_env_destroy(envid_t envid)
{
  ...
  800139:	68 0a 1f 80 00       	push   $0x801f0a
  80013e:	6a 23                	push   $0x23
  800140:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001c6:	68 0a 1f 80 00       	push   $0x801f0a
  8001cb:	6a 23                	push   $0x23
  8001cd:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80020c:	68 0a 1f 80 00       	push   $0x801f0a
  800211:	6a 23                	push   $0x23
  800213:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	68 0a 1f 80 00       	push   $0x801f0a
  800257:	6a 23                	push   $0x23
  800259:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800298:	68 0a 1f 80 00       	push   $0x801f0a
  80029d:	6a 23                	push   $0x23
  80029f:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002de:	68 0a 1f 80 00       	push   $0x801f0a
  8002e3:	6a 23                	push   $0x23
  8002e5:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800324:	68 0a 1f 80 00       	push   $0x801f0a
  800329:	6a 23                	push   $0x23
  80032b:	68 27 1f 80 00       	push   $0x801f27
...
sys_ipc_recv(void *dstva)
{
  ...
  800390:	68 0a 1f 80 00       	push   $0x801f0a
  800395:	6a 23                	push   $0x23
  800397:	68 27 1f 80 00       	push   $0x801f27
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800487:	ba b4 1f 80 00       	mov    $0x801fb4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800717:	53                   	push   %ebx
  800718:	50                   	push   %eax
  800719:	68 79 1f 80 00       	push   $0x801f79
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007e8:	53                   	push   %ebx
  8007e9:	50                   	push   %eax
  8007ea:	68 95 1f 80 00       	push   $0x801f95
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800898:	53                   	push   %ebx
  800899:	50                   	push   %eax
  80089a:	68 58 1f 80 00       	push   $0x801f58
...
00800ab8 <devfile_read>:
{
  ...
  800b11:	c3                   	ret    
	assert(r <= n);
  800b12:	68 c4 1f 80 00       	push   $0x801fc4
  ...
  800b2d:	68 cb 1f 80 00       	push   $0x801fcb
  800b32:	6a 7d                	push   $0x7d
  800b34:	68 e0 1f 80 00       	push   $0x801fe0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c07:	68 f7 1f 80 00       	push   $0x801ff7
  800c0c:	53                   	push   %ebx
...
00800c6b <_pipeisclosed>:
{
  ...
  800cae:	50                   	push   %eax
  800caf:	53                   	push   %ebx
  800cb0:	68 fe 1f 80 00       	push   $0x801ffe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f65:	68 16 20 80 00       	push   $0x802016
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801106:	56                   	push   %esi
  801107:	50                   	push   %eax
  801108:	68 24 20 80 00       	push   $0x802024
  ...
  801119:	e8 5a 00 00 00       	call   801178 <vcprintf>
	cprintf("\n");
  80111e:	c7 04 24 0f 20 80 00 	movl   $0x80200f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801279:	0f be 80 47 20 80 00 	movsbl 0x802047(%eax),%eax
  801280:	50                   	push   %eax
...
008012d0 <vprintfmt>:
{
  ...
  8013f8:	52                   	push   %edx
  8013f9:	68 dd 1f 80 00       	push   $0x801fdd
  8013fe:	53                   	push   %ebx
  8013ff:	56                   	push   %esi
  ...
  801410:	50                   	push   %eax
  801411:	68 5f 20 80 00       	push   $0x80205f
  801416:	53                   	push   %ebx
  801417:	56                   	push   %esi
  ...
  801438:	b8 58 20 80 00       	mov    $0x802058,%eax
