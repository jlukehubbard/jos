	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80020d:	0f be 80 f1 1e 80 00 	movsbl 0x801ef1(%eax),%eax
  800214:	50                   	push   %eax
...
00800264 <vprintfmt>:
{
  ...
  8002b4:	3e ff 24 85 40 20 80 	notrack jmp *0x802040(,%eax,4)
  8002bb:	00 
  ...
  800381:	8b 14 85 a0 21 80 00 	mov    0x8021a0(,%eax,4),%edx
  800388:	85 d2                	test   %edx,%edx
  80038a:	74 18                	je     8003a4 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80038c:	52                   	push   %edx
  80038d:	68 fa 22 80 00       	push   $0x8022fa
  800392:	53                   	push   %ebx
  800393:	56                   	push   %esi
  ...
  8003a4:	50                   	push   %eax
  8003a5:	68 09 1f 80 00       	push   $0x801f09
  8003aa:	53                   	push   %ebx
  8003ab:	56                   	push   %esi
  ...
  8003cc:	b8 02 1f 80 00       	mov    $0x801f02,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b55:	68 ff 21 80 00       	push   $0x8021ff
  800b5a:	6a 23                	push   $0x23
  800b5c:	68 1c 22 80 00       	push   $0x80221c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c6e:	68 ff 21 80 00       	push   $0x8021ff
  800c73:	6a 23                	push   $0x23
  800c75:	68 1c 22 80 00       	push   $0x80221c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cb4:	68 ff 21 80 00       	push   $0x8021ff
  800cb9:	6a 23                	push   $0x23
  800cbb:	68 1c 22 80 00       	push   $0x80221c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cfa:	68 ff 21 80 00       	push   $0x8021ff
  800cff:	6a 23                	push   $0x23
  800d01:	68 1c 22 80 00       	push   $0x80221c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d40:	68 ff 21 80 00       	push   $0x8021ff
  800d45:	6a 23                	push   $0x23
  800d47:	68 1c 22 80 00       	push   $0x80221c
...
sys_ipc_recv(void *dstva)
{
  ...
  800dac:	68 ff 21 80 00       	push   $0x8021ff
  800db1:	6a 23                	push   $0x23
  800db3:	68 1c 22 80 00       	push   $0x80221c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ea3:	ba a8 22 80 00       	mov    $0x8022a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ec5:	51                   	push   %ecx
  800ec6:	50                   	push   %eax
  800ec7:	68 2c 22 80 00       	push   $0x80222c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801133:	53                   	push   %ebx
  801134:	50                   	push   %eax
  801135:	68 6d 22 80 00       	push   $0x80226d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801204:	53                   	push   %ebx
  801205:	50                   	push   %eax
  801206:	68 89 22 80 00       	push   $0x802289
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012b4:	53                   	push   %ebx
  8012b5:	50                   	push   %eax
  8012b6:	68 4c 22 80 00       	push   $0x80224c
...
0080148a <devfile_write>:
{
  ...
  801494:	68 b8 22 80 00       	push   $0x8022b8
  801499:	68 90 00 00 00       	push   $0x90
  80149e:	68 d6 22 80 00       	push   $0x8022d6
...
008014a8 <devfile_read>:
{
  ...
  801501:	c3                   	ret    
	assert(r <= n);
  801502:	68 e1 22 80 00       	push   $0x8022e1
  801507:	68 e8 22 80 00       	push   $0x8022e8
  80150c:	6a 7c                	push   $0x7c
  80150e:	68 d6 22 80 00       	push   $0x8022d6
  801513:	e8 be 05 00 00       	call   801ad6 <_panic>
	assert(r <= PGSIZE);
  801518:	68 fd 22 80 00       	push   $0x8022fd
  80151d:	68 e8 22 80 00       	push   $0x8022e8
  801522:	6a 7d                	push   $0x7d
  801524:	68 d6 22 80 00       	push   $0x8022d6
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015f7:	68 09 23 80 00       	push   $0x802309
  8015fc:	53                   	push   %ebx
...
0080165b <_pipeisclosed>:
{
  ...
  80169e:	50                   	push   %eax
  80169f:	53                   	push   %ebx
  8016a0:	68 10 23 80 00       	push   $0x802310
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801955:	68 28 23 80 00       	push   $0x802328
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801af6:	56                   	push   %esi
  801af7:	50                   	push   %eax
  801af8:	68 34 23 80 00       	push   $0x802334
  ...
  801b09:	e8 fe e5 ff ff       	call   80010c <vcprintf>
	cprintf("\n");
  801b0e:	c7 04 24 21 23 80 00 	movl   $0x802321,(%esp)
