	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fb:	0f be 80 48 10 80 00 	movsbl 0x801048(%eax),%eax
  800202:	50                   	push   %eax
...
00800252 <vprintfmt>:
{
  ...
  8002a2:	3e ff 24 85 00 11 80 	notrack jmp *0x801100(,%eax,4)
  8002a9:	00 
  ...
  80036f:	8b 14 85 60 12 80 00 	mov    0x801260(,%eax,4),%edx
  800376:	85 d2                	test   %edx,%edx
  800378:	74 18                	je     800392 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80037a:	52                   	push   %edx
  80037b:	68 69 10 80 00       	push   $0x801069
  800380:	53                   	push   %ebx
  800381:	56                   	push   %esi
  ...
  800392:	50                   	push   %eax
  800393:	68 60 10 80 00       	push   $0x801060
  800398:	53                   	push   %ebx
  800399:	56                   	push   %esi
  ...
  8003ba:	b8 59 10 80 00       	mov    $0x801059,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd0:	68 84 12 80 00       	push   $0x801284
  800bd5:	6a 23                	push   $0x23
  800bd7:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c16:	68 84 12 80 00       	push   $0x801284
  800c1b:	6a 23                	push   $0x23
  800c1d:	68 a1 12 80 00       	push   $0x8012a1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c5c:	68 84 12 80 00       	push   $0x801284
  800c61:	6a 23                	push   $0x23
  800c63:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ca2:	68 84 12 80 00       	push   $0x801284
  800ca7:	6a 23                	push   $0x23
  800ca9:	68 a1 12 80 00       	push   $0x8012a1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce8:	68 84 12 80 00       	push   $0x801284
  800ced:	6a 23                	push   $0x23
  800cef:	68 a1 12 80 00       	push   $0x8012a1
...
sys_ipc_recv(void *dstva)
{
  ...
  800d54:	68 84 12 80 00       	push   $0x801284
  800d59:	6a 23                	push   $0x23
  800d5b:	68 a1 12 80 00       	push   $0x8012a1
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d85:	56                   	push   %esi
  800d86:	50                   	push   %eax
  800d87:	68 b0 12 80 00       	push   $0x8012b0
  ...
  800d98:	e8 5d f3 ff ff       	call   8000fa <vcprintf>
	cprintf("\n");
  800d9d:	c7 04 24 3c 10 80 00 	movl   $0x80103c,(%esp)
