	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80020d:	0f be 80 28 1f 80 00 	movsbl 0x801f28(%eax),%eax
  800214:	50                   	push   %eax
...
00800264 <vprintfmt>:
{
  ...
  8002b4:	3e ff 24 85 60 20 80 	notrack jmp *0x802060(,%eax,4)
  8002bb:	00 
  ...
  800381:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  800388:	85 d2                	test   %edx,%edx
  80038a:	74 18                	je     8003a4 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80038c:	52                   	push   %edx
  80038d:	68 f1 22 80 00       	push   $0x8022f1
  800392:	53                   	push   %ebx
  800393:	56                   	push   %esi
  ...
  8003a4:	50                   	push   %eax
  8003a5:	68 40 1f 80 00       	push   $0x801f40
  8003aa:	53                   	push   %ebx
  8003ab:	56                   	push   %esi
  ...
  8003cc:	b8 39 1f 80 00       	mov    $0x801f39,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b55:	68 1f 22 80 00       	push   $0x80221f
  800b5a:	6a 23                	push   $0x23
  800b5c:	68 3c 22 80 00       	push   $0x80223c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c6e:	68 1f 22 80 00       	push   $0x80221f
  800c73:	6a 23                	push   $0x23
  800c75:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cb4:	68 1f 22 80 00       	push   $0x80221f
  800cb9:	6a 23                	push   $0x23
  800cbb:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cfa:	68 1f 22 80 00       	push   $0x80221f
  800cff:	6a 23                	push   $0x23
  800d01:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d40:	68 1f 22 80 00       	push   $0x80221f
  800d45:	6a 23                	push   $0x23
  800d47:	68 3c 22 80 00       	push   $0x80223c
...
sys_ipc_recv(void *dstva)
{
  ...
  800dac:	68 1f 22 80 00       	push   $0x80221f
  800db1:	6a 23                	push   $0x23
  800db3:	68 3c 22 80 00       	push   $0x80223c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ea3:	ba c8 22 80 00       	mov    $0x8022c8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ec5:	51                   	push   %ecx
  800ec6:	50                   	push   %eax
  800ec7:	68 4c 22 80 00       	push   $0x80224c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801133:	53                   	push   %ebx
  801134:	50                   	push   %eax
  801135:	68 8d 22 80 00       	push   $0x80228d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801204:	53                   	push   %ebx
  801205:	50                   	push   %eax
  801206:	68 a9 22 80 00       	push   $0x8022a9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012b4:	53                   	push   %ebx
  8012b5:	50                   	push   %eax
  8012b6:	68 6c 22 80 00       	push   $0x80226c
...
008014d4 <devfile_read>:
{
  ...
  80152d:	c3                   	ret    
	assert(r <= n);
  80152e:	68 d8 22 80 00       	push   $0x8022d8
  801533:	68 df 22 80 00       	push   $0x8022df
  801538:	6a 7c                	push   $0x7c
  80153a:	68 f4 22 80 00       	push   $0x8022f4
  80153f:	e8 be 05 00 00       	call   801b02 <_panic>
	assert(r <= PGSIZE);
  801544:	68 ff 22 80 00       	push   $0x8022ff
  801549:	68 df 22 80 00       	push   $0x8022df
  80154e:	6a 7d                	push   $0x7d
  801550:	68 f4 22 80 00       	push   $0x8022f4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801623:	68 0b 23 80 00       	push   $0x80230b
  801628:	53                   	push   %ebx
...
00801687 <_pipeisclosed>:
{
  ...
  8016ca:	50                   	push   %eax
  8016cb:	53                   	push   %ebx
  8016cc:	68 12 23 80 00       	push   $0x802312
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801981:	68 2a 23 80 00       	push   $0x80232a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b22:	56                   	push   %esi
  801b23:	50                   	push   %eax
  801b24:	68 38 23 80 00       	push   $0x802338
  ...
  801b35:	e8 d2 e5 ff ff       	call   80010c <vcprintf>
	cprintf("\n");
  801b3a:	c7 04 24 1c 1f 80 00 	movl   $0x801f1c,(%esp)
