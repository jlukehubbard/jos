...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 18             	sub    $0x18,%esp
	...
	if ((who = fork()) == 0) {
  80003d:	e8 96 0f 00 00       	call   800fd8 <fork>
  ...
  800085:	e8 63 0a 00 00       	call   800aed <memcpy>
    cprintf("parent sent\n");
  80008a:	c7 04 24 00 16 80 00 	movl   $0x801600,(%esp)
  ...
  8000a2:	e8 32 11 00 00       	call   8011d9 <ipc_send>
  ...
  800180:	e8 54 10 00 00       	call   8011d9 <ipc_send>
        cprintf("child sent\n");
  800185:	83 c4 14             	add    $0x14,%esp
  800188:	68 f4 15 80 00       	push   $0x8015f4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80032e:	e8 3d 10 00 00       	call   801370 <__udivdi3>
  ...
  80036c:	e8 0f 11 00 00       	call   801480 <__umoddi3>
  800371:	83 c4 14             	add    $0x14,%esp
  800374:	0f be 80 a8 16 80 00 	movsbl 0x8016a8(%eax),%eax
  80037b:	50                   	push   %eax
...
008003cb <vprintfmt>:
{
  ...
  80041b:	3e ff 24 85 e0 17 80 	notrack jmp *0x8017e0(,%eax,4)
  800422:	00 
  ...
  8004e8:	8b 14 85 40 19 80 00 	mov    0x801940(,%eax,4),%edx
  8004ef:	85 d2                	test   %edx,%edx
  8004f1:	74 18                	je     80050b <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8004f3:	52                   	push   %edx
  8004f4:	68 c9 16 80 00       	push   $0x8016c9
  8004f9:	53                   	push   %ebx
  8004fa:	56                   	push   %esi
  ...
  80050b:	50                   	push   %eax
  80050c:	68 c0 16 80 00       	push   $0x8016c0
  800511:	53                   	push   %ebx
  800512:	56                   	push   %esi
  ...
  800533:	b8 b9 16 80 00       	mov    $0x8016b9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800cbc:	68 9f 19 80 00       	push   $0x80199f
  800cc1:	6a 23                	push   $0x23
  800cc3:	68 bc 19 80 00       	push   $0x8019bc
  800cc8:	e8 af 05 00 00       	call   80127c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d49:	68 9f 19 80 00       	push   $0x80199f
  800d4e:	6a 23                	push   $0x23
  800d50:	68 bc 19 80 00       	push   $0x8019bc
  800d55:	e8 22 05 00 00       	call   80127c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d8f:	68 9f 19 80 00       	push   $0x80199f
  800d94:	6a 23                	push   $0x23
  800d96:	68 bc 19 80 00       	push   $0x8019bc
  800d9b:	e8 dc 04 00 00       	call   80127c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800dd5:	68 9f 19 80 00       	push   $0x80199f
  800dda:	6a 23                	push   $0x23
  800ddc:	68 bc 19 80 00       	push   $0x8019bc
  800de1:	e8 96 04 00 00       	call   80127c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e1b:	68 9f 19 80 00       	push   $0x80199f
  800e20:	6a 23                	push   $0x23
  800e22:	68 bc 19 80 00       	push   $0x8019bc
  800e27:	e8 50 04 00 00       	call   80127c <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e61:	68 9f 19 80 00       	push   $0x80199f
  800e66:	6a 23                	push   $0x23
  800e68:	68 bc 19 80 00       	push   $0x8019bc
  800e6d:	e8 0a 04 00 00       	call   80127c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ea7:	68 9f 19 80 00       	push   $0x80199f
  800eac:	6a 23                	push   $0x23
  800eae:	68 bc 19 80 00       	push   $0x8019bc
  800eb3:	e8 c4 03 00 00       	call   80127c <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ef1:	b8 0d 00 00 00       	mov    $0xd,%eax
...
pgfault(struct UTrapframe *utf)
{
  ...
  800f17:	74 75                	je     800f8e <pgfault+0x8b>
  ...
  800f31:	e8 dd fd ff ff       	call   800d13 <sys_page_alloc>
  800f36:	83 c4 10             	add    $0x10,%esp
  800f39:	85 c0                	test   %eax,%eax
  800f3b:	78 65                	js     800fa2 <pgfault+0x9f>
  ...
  800f51:	e8 31 fb ff ff       	call   800a87 <memmove>
  ...
  800f67:	e8 ee fd ff ff       	call   800d5a <sys_page_map>
  800f6c:	83 c4 20             	add    $0x20,%esp
  800f6f:	85 c0                	test   %eax,%eax
  800f71:	78 41                	js     800fb4 <pgfault+0xb1>
  ...
  800f7d:	e8 1e fe ff ff       	call   800da0 <sys_page_unmap>
  800f82:	83 c4 10             	add    $0x10,%esp
  800f85:	85 c0                	test   %eax,%eax
  800f87:	78 3d                	js     800fc6 <pgfault+0xc3>
  ...
  800f91:	68 ca 19 80 00       	push   $0x8019ca
  800f96:	6a 1e                	push   $0x1e
  800f98:	68 e3 19 80 00       	push   $0x8019e3
  800f9d:	e8 da 02 00 00       	call   80127c <_panic>
        panic("sys_page_alloc failed %e\n", r);
  800fa2:	50                   	push   %eax
  800fa3:	68 ee 19 80 00       	push   $0x8019ee
  800fa8:	6a 2a                	push   $0x2a
  800faa:	68 e3 19 80 00       	push   $0x8019e3
  800faf:	e8 c8 02 00 00       	call   80127c <_panic>
        panic("sys_page_map failed %e\n", r);
  800fb4:	50                   	push   %eax
  800fb5:	68 08 1a 80 00       	push   $0x801a08
  800fba:	6a 2f                	push   $0x2f
  800fbc:	68 e3 19 80 00       	push   $0x8019e3
  800fc1:	e8 b6 02 00 00       	call   80127c <_panic>
        panic("sys_page_unmap failed %e\n", r);
  800fc6:	50                   	push   %eax
  800fc7:	68 20 1a 80 00       	push   $0x801a20
  800fcc:	6a 32                	push   $0x32
  800fce:	68 e3 19 80 00       	push   $0x8019e3
  800fd3:	e8 a4 02 00 00       	call   80127c <_panic>
...
fork(void)
{
  ...
  800fe5:	68 03 0f 80 00       	push   $0x800f03
  800fea:	e8 d7 02 00 00       	call   8012c6 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800ff9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  801001:	78 2a                	js     80102d <fork+0x55>
  ...
  801003:	bb 00 00 00 00       	mov    $0x0,%ebx
    if (envid == 0) {
  801008:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  80100c:	75 63                	jne    801071 <fork+0x99>
        envid_t my_envid = sys_getenvid();
  80100e:	e8 ba fc ff ff       	call   800ccd <sys_getenvid>
        thisenv = &envs[ENVX(my_envid)];
  801013:	25 ff 03 00 00       	and    $0x3ff,%eax
  801018:	6b c0 7c             	imul   $0x7c,%eax,%eax
  80101b:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801020:	a3 0c 20 80 00       	mov    %eax,0x80200c
        return 0;
  801025:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801028:	e9 2f 01 00 00       	jmp    80115c <fork+0x184>
        panic("fork, sys_exofork %e", envid);
  80102d:	50                   	push   %eax
  80102e:	68 3a 1a 80 00       	push   $0x801a3a
  801033:	68 82 00 00 00       	push   $0x82
  801038:	68 e3 19 80 00       	push   $0x8019e3
  80103d:	e8 3a 02 00 00       	call   80127c <_panic>
  ...
  801052:	e8 03 fd ff ff       	call   800d5a <sys_page_map>
  801057:	83 c4 20             	add    $0x20,%esp
  80105a:	85 c0                	test   %eax,%eax
  80105c:	0f 88 90 00 00 00    	js     8010f2 <fork+0x11a>
        for (uint32_t pn = 0; pn < (USTACKTOP >> PGSHIFT); ++pn) {
  801062:	83 c3 01             	add    $0x1,%ebx
  801065:	81 fb fe eb 0e 00    	cmp    $0xeebfe,%ebx
  80106b:	0f 84 a5 00 00 00    	je     801116 <fork+0x13e>
  ...
  801084:	74 dc                	je     801062 <fork+0x8a>
                    (uvpt[pn] & PTE_P) ) {
  801086:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
            if ( (uvpd[PDX(pgaddr)] & PTE_P) &&
  80108d:	a8 01                	test   $0x1,%al
  80108f:	74 d1                	je     801062 <fork+0x8a>
    pte_t pte = uvpt[pn];
  801091:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
    if ( pte & PTE_SHARE) {
  801098:	f6 c4 04             	test   $0x4,%ah
  80109b:	75 a5                	jne    801042 <fork+0x6a>
  ...
  8010b6:	57                   	push   %edi
  8010b7:	56                   	push   %esi
  8010b8:	ff 75 e4             	pushl  -0x1c(%ebp)
  8010bb:	56                   	push   %esi
  8010bc:	6a 00                	push   $0x0
  8010be:	e8 97 fc ff ff       	call   800d5a <sys_page_map>
  8010c3:	83 c4 20             	add    $0x20,%esp
  8010c6:	85 c0                	test   %eax,%eax
  8010c8:	78 3a                	js     801104 <fork+0x12c>
  ...
  8010d4:	e8 81 fc ff ff       	call   800d5a <sys_page_map>
  8010d9:	83 c4 20             	add    $0x20,%esp
  8010dc:	85 c0                	test   %eax,%eax
  8010de:	79 82                	jns    801062 <fork+0x8a>
            panic("sys_page_map mine failed %e\n", r);
  8010e0:	50                   	push   %eax
  8010e1:	68 4f 1a 80 00       	push   $0x801a4f
  8010e6:	6a 5d                	push   $0x5d
  8010e8:	68 e3 19 80 00       	push   $0x8019e3
  8010ed:	e8 8a 01 00 00       	call   80127c <_panic>
    	    panic("sys_page_map others failed %e\n", r);
  8010f2:	50                   	push   %eax
  8010f3:	68 84 1a 80 00       	push   $0x801a84
  8010f8:	6a 4d                	push   $0x4d
  8010fa:	68 e3 19 80 00       	push   $0x8019e3
  8010ff:	e8 78 01 00 00       	call   80127c <_panic>
        panic("sys_page_map others failed %e\n", r);
  801104:	50                   	push   %eax
  801105:	68 84 1a 80 00       	push   $0x801a84
  80110a:	6a 58                	push   $0x58
  80110c:	68 e3 19 80 00       	push   $0x8019e3
  801111:	e8 66 01 00 00       	call   80127c <_panic>
            }
        }
  ...
  801120:	8b 7d e0             	mov    -0x20(%ebp),%edi
  801123:	57                   	push   %edi
  801124:	e8 ea fb ff ff       	call   800d13 <sys_page_alloc>
  801129:	83 c4 10             	add    $0x10,%esp
  80112c:	85 c0                	test   %eax,%eax
  80112e:	78 2c                	js     80115c <fork+0x184>
                    PTE_U | PTE_W | PTE_P)) < 0) {
            return r;
        }
  ...
  801130:	a1 0c 20 80 00       	mov    0x80200c,%eax
        if ((r = sys_env_set_pgfault_upcall(envid,
  801135:	8b 40 64             	mov    0x64(%eax),%eax
  801138:	83 ec 08             	sub    $0x8,%esp
  80113b:	50                   	push   %eax
  80113c:	57                   	push   %edi
  80113d:	e8 30 fd ff ff       	call   800e72 <sys_env_set_pgfault_upcall>
  801142:	83 c4 10             	add    $0x10,%esp
  801145:	85 c0                	test   %eax,%eax
  801147:	78 13                	js     80115c <fork+0x184>
            return r;
        }
  ...
  80114e:	57                   	push   %edi
  80114f:	e8 92 fc ff ff       	call   800de6 <sys_env_set_status>
...
sfork(void)
{
  ...
  80116e:	68 6c 1a 80 00       	push   $0x801a6c
  801173:	68 ac 00 00 00       	push   $0xac
  801178:	68 e3 19 80 00       	push   $0x8019e3
  80117d:	e8 fa 00 00 00       	call   80127c <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801196:	ba 00 00 00 f0       	mov    $0xf0000000,%edx
  80119b:	0f 44 c2             	cmove  %edx,%eax
  80119e:	83 ec 0c             	sub    $0xc,%esp
  8011a1:	50                   	push   %eax
  8011a2:	e8 38 fd ff ff       	call   800edf <sys_ipc_recv>
  8011a7:	83 c4 10             	add    $0x10,%esp
  8011aa:	85 c0                	test   %eax,%eax
  8011ac:	78 24                	js     8011d2 <ipc_recv+0x50>
        return ret;
    }

    if (perm_store) {
  8011ae:	85 f6                	test   %esi,%esi
  8011b0:	74 0a                	je     8011bc <ipc_recv+0x3a>
        *perm_store = thisenv->env_ipc_perm;
  8011b2:	a1 0c 20 80 00       	mov    0x80200c,%eax
  ...
  8011be:	74 0a                	je     8011ca <ipc_recv+0x48>
        *from_env_store = thisenv->env_ipc_from;
  8011c0:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011c5:	8b 40 74             	mov    0x74(%eax),%eax
  8011c8:	89 03                	mov    %eax,(%ebx)
    }

	return thisenv->env_ipc_value;
  8011ca:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8011cf:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8011eb:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  8011f0:	0f 45 d0             	cmovne %eax,%edx
  8011f3:	89 d7                	mov    %edx,%edi
    ...
    int threshold = 16;
    int cur_wait = 1;
  8011f5:	be 01 00 00 00       	mov    $0x1,%esi
  8011fa:	eb 1f                	jmp    80121b <ipc_send+0x42>
        ...
        for (int i=0; i<cur_wait; ++i) {
            sys_yield();
  8011fc:	e8 ef fa ff ff       	call   800cf0 <sys_yield>
        for (int i=0; i<cur_wait; ++i) {
  801201:	83 c3 01             	add    $0x1,%ebx
  801204:	39 de                	cmp    %ebx,%esi
  801206:	7f f4                	jg     8011fc <ipc_send+0x23>
        }
        // update wait value
        cur_wait <<= 1;
  801208:	01 f6                	add    %esi,%esi
        if (cur_wait > threshold) {
            cur_wait = 1;
  80120a:	83 fe 11             	cmp    $0x11,%esi
  80120d:	b8 01 00 00 00       	mov    $0x1,%eax
  801212:	0f 4d f0             	cmovge %eax,%esi
        }

    }
    while (ret == -E_IPC_NOT_RECV);
  801215:	83 7d e4 f9          	cmpl   $0xfffffff9,-0x1c(%ebp)
  801219:	75 1c                	jne    801237 <ipc_send+0x5e>
        ret = sys_ipc_try_send(to_env, val, pg == NULL ? (void*)-1 : pg, perm);
  80121b:	ff 75 14             	pushl  0x14(%ebp)
  80121e:	57                   	push   %edi
  80121f:	ff 75 0c             	pushl  0xc(%ebp)
  801222:	ff 75 08             	pushl  0x8(%ebp)
  801225:	e8 8e fc ff ff       	call   800eb8 <sys_ipc_try_send>
  80122a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        for (int i=0; i<cur_wait; ++i) {
  80122d:	83 c4 10             	add    $0x10,%esp
  801230:	bb 00 00 00 00       	mov    $0x0,%ebx
  801235:	eb cd                	jmp    801204 <ipc_send+0x2b>
}
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801284:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  801285:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  801288:	8b 35 08 20 80 00    	mov    0x802008,%esi
  80128e:	e8 3a fa ff ff       	call   800ccd <sys_getenvid>
  801293:	83 ec 0c             	sub    $0xc,%esp
  801296:	ff 75 0c             	pushl  0xc(%ebp)
  801299:	ff 75 08             	pushl  0x8(%ebp)
  80129c:	56                   	push   %esi
  80129d:	50                   	push   %eax
  80129e:	68 a4 1a 80 00       	push   $0x801aa4
  8012a3:	e8 20 f0 ff ff       	call   8002c8 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8012a8:	83 c4 18             	add    $0x18,%esp
  8012ab:	53                   	push   %ebx
  8012ac:	ff 75 10             	pushl  0x10(%ebp)
  8012af:	e8 bf ef ff ff       	call   800273 <vcprintf>
	cprintf("\n");
  8012b4:	c7 04 24 d4 1a 80 00 	movl   $0x801ad4,(%esp)
  8012bb:	e8 08 f0 ff ff       	call   8002c8 <cprintf>
  8012c0:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8012c3:	cc                   	int3   
  8012c4:	eb fd                	jmp    8012c3 <_panic+0x47>

008012c6 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8012d7:	74 0a                	je     8012e3 <set_pgfault_handler+0x1d>
        }
  ...
  8012dc:	a3 10 20 80 00       	mov    %eax,0x802010
}
  8012e1:	c9                   	leave  
  8012e2:	c3                   	ret    
        cprintf("UXSTACK alloc\n");
  8012e3:	83 ec 0c             	sub    $0xc,%esp
  8012e6:	68 c7 1a 80 00       	push   $0x801ac7
  8012eb:	e8 d8 ef ff ff       	call   8002c8 <cprintf>
        if (sys_page_alloc(0, (void*)(UXSTACKTOP-PGSIZE), PTE_U | PTE_W | PTE_P) < 0) {
  8012f0:	83 c4 0c             	add    $0xc,%esp
  8012f3:	6a 07                	push   $0x7
  8012f5:	68 00 f0 bf ee       	push   $0xeebff000
  8012fa:	6a 00                	push   $0x0
  8012fc:	e8 12 fa ff ff       	call   800d13 <sys_page_alloc>
  801301:	83 c4 10             	add    $0x10,%esp
  801304:	85 c0                	test   %eax,%eax
  801306:	78 2a                	js     801332 <set_pgfault_handler+0x6c>
        if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0) {
  801308:	83 ec 08             	sub    $0x8,%esp
  80130b:	68 46 13 80 00       	push   $0x801346
  801310:	6a 00                	push   $0x0
  801312:	e8 5b fb ff ff       	call   800e72 <sys_env_set_pgfault_upcall>
  801317:	83 c4 10             	add    $0x10,%esp
  80131a:	85 c0                	test   %eax,%eax
  80131c:	79 bb                	jns    8012d9 <set_pgfault_handler+0x13>
            panic("sys_env_set_pgfault_upcall failed!");
  80131e:	83 ec 04             	sub    $0x4,%esp
  801321:	68 04 1b 80 00       	push   $0x801b04
  801326:	6a 25                	push   $0x25
  801328:	68 f4 1a 80 00       	push   $0x801af4
  80132d:	e8 4a ff ff ff       	call   80127c <_panic>
            panic("Allocation of UXSTACK failed!");
  801332:	83 ec 04             	sub    $0x4,%esp
  801335:	68 d6 1a 80 00       	push   $0x801ad6
  80133a:	6a 22                	push   $0x22
  80133c:	68 f4 1a 80 00       	push   $0x801af4
  801341:	e8 36 ff ff ff       	call   80127c <_panic>
...
_pgfault_upcall:
  ...
  801347:	a1 10 20 80 00       	mov    0x802010,%eax
	call *%eax
  ...
  80134e:	83 c4 04             	add    $0x4,%esp
    ...
    mov 40(%esp), %ebp
  801351:	8b 6c 24 28          	mov    0x28(%esp),%ebp
    // load trap-time esp to edi
    mov 48(%esp), %edi
  801355:	8b 7c 24 30          	mov    0x30(%esp),%edi
    // push trap-time eip to trap-time esp
    mov %ebp, -4(%edi)
  801359:	89 6f fc             	mov    %ebp,-0x4(%edi)
  ...
  801363:	9d                   	popf   
	...
	// LAB 4: Your code here.
    mov (%esp), %esp
  801364:	8b 24 24             	mov    (%esp),%esp

	// Return to re-execute the instruction that faulted.
	// LAB 4: Your code here.
    lea -4(%esp), %esp
  801367:	8d 64 24 fc          	lea    -0x4(%esp),%esp
    ret
  80136b:	c3                   	ret    
...
00801370 <__udivdi3>:
  ...
  80137b:	8b 54 24 3c          	mov    0x3c(%esp),%edx
  80137f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
  801383:	8b 74 24 34          	mov    0x34(%esp),%esi
  801387:	8b 5c 24 38          	mov    0x38(%esp),%ebx
  80138b:	85 d2                	test   %edx,%edx
  80138d:	75 19                	jne    8013a8 <__udivdi3+0x38>
  80138f:	39 f3                	cmp    %esi,%ebx
  801391:	76 4d                	jbe    8013e0 <__udivdi3+0x70>
  801393:	31 ff                	xor    %edi,%edi
  801395:	89 e8                	mov    %ebp,%eax
  801397:	89 f2                	mov    %esi,%edx
  801399:	f7 f3                	div    %ebx
  ...
  8013aa:	76 14                	jbe    8013c0 <__udivdi3+0x50>
  8013ac:	31 ff                	xor    %edi,%edi
  8013ae:	31 c0                	xor    %eax,%eax
  ...
  8013c0:	0f bd fa             	bsr    %edx,%edi
  8013c3:	83 f7 1f             	xor    $0x1f,%edi
  8013c6:	75 48                	jne    801410 <__udivdi3+0xa0>
  8013c8:	39 f2                	cmp    %esi,%edx
  8013ca:	72 06                	jb     8013d2 <__udivdi3+0x62>
  8013cc:	31 c0                	xor    %eax,%eax
  8013ce:	39 eb                	cmp    %ebp,%ebx
  8013d0:	77 de                	ja     8013b0 <__udivdi3+0x40>
  8013d2:	b8 01 00 00 00       	mov    $0x1,%eax
  8013d7:	eb d7                	jmp    8013b0 <__udivdi3+0x40>
  8013d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8013e0:	89 d9                	mov    %ebx,%ecx
  8013e2:	85 db                	test   %ebx,%ebx
  8013e4:	75 0b                	jne    8013f1 <__udivdi3+0x81>
  8013e6:	b8 01 00 00 00       	mov    $0x1,%eax
  8013eb:	31 d2                	xor    %edx,%edx
  8013ed:	f7 f3                	div    %ebx
  8013ef:	89 c1                	mov    %eax,%ecx
  8013f1:	31 d2                	xor    %edx,%edx
  8013f3:	89 f0                	mov    %esi,%eax
  8013f5:	f7 f1                	div    %ecx
  8013f7:	89 c6                	mov    %eax,%esi
  8013f9:	89 e8                	mov    %ebp,%eax
  8013fb:	89 f7                	mov    %esi,%edi
  8013fd:	f7 f1                	div    %ecx
  ...
  801410:	89 f9                	mov    %edi,%ecx
  801412:	b8 20 00 00 00       	mov    $0x20,%eax
  801417:	29 f8                	sub    %edi,%eax
  801419:	d3 e2                	shl    %cl,%edx
  80141b:	89 54 24 08          	mov    %edx,0x8(%esp)
  80141f:	89 c1                	mov    %eax,%ecx
  801421:	89 da                	mov    %ebx,%edx
  801423:	d3 ea                	shr    %cl,%edx
  801425:	8b 4c 24 08          	mov    0x8(%esp),%ecx
  801429:	09 d1                	or     %edx,%ecx
  80142b:	89 f2                	mov    %esi,%edx
  80142d:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801431:	89 f9                	mov    %edi,%ecx
  801433:	d3 e3                	shl    %cl,%ebx
  801435:	89 c1                	mov    %eax,%ecx
  801437:	d3 ea                	shr    %cl,%edx
  801439:	89 f9                	mov    %edi,%ecx
  80143b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80143f:	89 eb                	mov    %ebp,%ebx
  801441:	d3 e6                	shl    %cl,%esi
  801443:	89 c1                	mov    %eax,%ecx
  801445:	d3 eb                	shr    %cl,%ebx
  801447:	09 de                	or     %ebx,%esi
  801449:	89 f0                	mov    %esi,%eax
  80144b:	f7 74 24 08          	divl   0x8(%esp)
  80144f:	89 d6                	mov    %edx,%esi
  801451:	89 c3                	mov    %eax,%ebx
  801453:	f7 64 24 0c          	mull   0xc(%esp)
  801457:	39 d6                	cmp    %edx,%esi
  801459:	72 15                	jb     801470 <__udivdi3+0x100>
  80145b:	89 f9                	mov    %edi,%ecx
  80145d:	d3 e5                	shl    %cl,%ebp
  80145f:	39 c5                	cmp    %eax,%ebp
  801461:	73 04                	jae    801467 <__udivdi3+0xf7>
  801463:	39 d6                	cmp    %edx,%esi
  801465:	74 09                	je     801470 <__udivdi3+0x100>
  801467:	89 d8                	mov    %ebx,%eax
  801469:	31 ff                	xor    %edi,%edi
  80146b:	e9 40 ff ff ff       	jmp    8013b0 <__udivdi3+0x40>
  801470:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801473:	31 ff                	xor    %edi,%edi
  801475:	e9 36 ff ff ff       	jmp    8013b0 <__udivdi3+0x40>
...
00801480 <__umoddi3>:
  ...
  80148b:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  80148f:	8b 74 24 30          	mov    0x30(%esp),%esi
  801493:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  801497:	8b 7c 24 38          	mov    0x38(%esp),%edi
  80149b:	85 c0                	test   %eax,%eax
  80149d:	75 19                	jne    8014b8 <__umoddi3+0x38>
  80149f:	39 df                	cmp    %ebx,%edi
  8014a1:	76 5d                	jbe    801500 <__umoddi3+0x80>
  8014a3:	89 f0                	mov    %esi,%eax
  8014a5:	89 da                	mov    %ebx,%edx
  ...
  8014ba:	39 d8                	cmp    %ebx,%eax
  8014bc:	76 12                	jbe    8014d0 <__umoddi3+0x50>
  ...
  8014d6:	75 50                	jne    801528 <__umoddi3+0xa8>
  8014d8:	39 d8                	cmp    %ebx,%eax
  8014da:	0f 82 e0 00 00 00    	jb     8015c0 <__umoddi3+0x140>
  8014e0:	89 d9                	mov    %ebx,%ecx
  8014e2:	39 f7                	cmp    %esi,%edi
  8014e4:	0f 86 d6 00 00 00    	jbe    8015c0 <__umoddi3+0x140>
  ...
  80155f:	d3 e3                	shl    %cl,%ebx
  801561:	89 c7                	mov    %eax,%edi
  801563:	89 d1                	mov    %edx,%ecx
  801565:	89 f0                	mov    %esi,%eax
  801567:	d3 e8                	shr    %cl,%eax
  801569:	89 e9                	mov    %ebp,%ecx
  80156b:	89 fa                	mov    %edi,%edx
  80156d:	d3 e6                	shl    %cl,%esi
  80156f:	09 d8                	or     %ebx,%eax
  801571:	f7 74 24 08          	divl   0x8(%esp)
  801575:	89 d1                	mov    %edx,%ecx
  801577:	89 f3                	mov    %esi,%ebx
  801579:	f7 64 24 0c          	mull   0xc(%esp)
  80157d:	89 c6                	mov    %eax,%esi
  80157f:	89 d7                	mov    %edx,%edi
  801581:	39 d1                	cmp    %edx,%ecx
  801583:	72 06                	jb     80158b <__umoddi3+0x10b>
  801585:	75 10                	jne    801597 <__umoddi3+0x117>
  801587:	39 c3                	cmp    %eax,%ebx
  801589:	73 0c                	jae    801597 <__umoddi3+0x117>
  80158b:	2b 44 24 0c          	sub    0xc(%esp),%eax
  80158f:	1b 54 24 08          	sbb    0x8(%esp),%edx
  801593:	89 d7                	mov    %edx,%edi
  801595:	89 c6                	mov    %eax,%esi
  801597:	89 ca                	mov    %ecx,%edx
  801599:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  80159e:	29 f3                	sub    %esi,%ebx
  8015a0:	19 fa                	sbb    %edi,%edx
  8015a2:	89 d0                	mov    %edx,%eax
  8015a4:	d3 e0                	shl    %cl,%eax
  8015a6:	89 e9                	mov    %ebp,%ecx
  8015a8:	d3 eb                	shr    %cl,%ebx
  8015aa:	d3 ea                	shr    %cl,%edx
  8015ac:	09 d8                	or     %ebx,%eax
  ...
  8015c0:	29 fe                	sub    %edi,%esi
  8015c2:	19 c3                	sbb    %eax,%ebx
  8015c4:	89 f2                	mov    %esi,%edx
  8015c6:	89 d9                	mov    %ebx,%ecx
  8015c8:	e9 1d ff ff ff       	jmp    8014ea <__umoddi3+0x6a>
