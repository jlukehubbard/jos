...
00800073 <forkchild>:
{
  ...
  8000b7:	e8 4a 0e 00 00       	call   800f06 <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025c:	e8 3f 0f 00 00       	call   8011a0 <__udivdi3>
  ...
  80029a:	e8 11 10 00 00       	call   8012b0 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf6:	e8 b5 04 00 00       	call   8010b0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c83:	e8 28 04 00 00       	call   8010b0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cc9:	e8 e2 03 00 00       	call   8010b0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d0f:	e8 9c 03 00 00       	call   8010b0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d55:	e8 56 03 00 00       	call   8010b0 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d9b:	e8 10 03 00 00       	call   8010b0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800de1:	e8 ca 02 00 00       	call   8010b0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e1f:	b8 0d 00 00 00       	mov    $0xd,%eax
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e3f:	8b 18                	mov    (%eax),%ebx
    ...
    if ( !(err & FEC_WR) ||
  800e41:	f6 40 04 02          	testb  $0x2,0x4(%eax)
  800e45:	74 75                	je     800ebc <pgfault+0x8b>
  ...
  800e5f:	e8 dd fd ff ff       	call   800c41 <sys_page_alloc>
  800e64:	83 c4 10             	add    $0x10,%esp
  800e67:	85 c0                	test   %eax,%eax
  800e69:	78 65                	js     800ed0 <pgfault+0x9f>
  ...
  800e7f:	e8 31 fb ff ff       	call   8009b5 <memmove>
  ...
  800e95:	e8 ee fd ff ff       	call   800c88 <sys_page_map>
  800e9a:	83 c4 20             	add    $0x20,%esp
  800e9d:	85 c0                	test   %eax,%eax
  800e9f:	78 41                	js     800ee2 <pgfault+0xb1>
  ...
  800eab:	e8 1e fe ff ff       	call   800cce <sys_page_unmap>
  800eb0:	83 c4 10             	add    $0x10,%esp
  800eb3:	85 c0                	test   %eax,%eax
  800eb5:	78 3d                	js     800ef4 <pgfault+0xc3>
  ...
  800ebf:	68 4a 17 80 00       	push   $0x80174a
  800ec4:	6a 1e                	push   $0x1e
  800ec6:	68 63 17 80 00       	push   $0x801763
  800ecb:	e8 e0 01 00 00       	call   8010b0 <_panic>
        panic("sys_page_alloc failed %e\n", r);
  800ed0:	50                   	push   %eax
  800ed1:	68 6e 17 80 00       	push   $0x80176e
  800ed6:	6a 2a                	push   $0x2a
  800ed8:	68 63 17 80 00       	push   $0x801763
  800edd:	e8 ce 01 00 00       	call   8010b0 <_panic>
        panic("sys_page_map failed %e\n", r);
  800ee2:	50                   	push   %eax
  800ee3:	68 88 17 80 00       	push   $0x801788
  800ee8:	6a 2f                	push   $0x2f
  800eea:	68 63 17 80 00       	push   $0x801763
  800eef:	e8 bc 01 00 00       	call   8010b0 <_panic>
        panic("sys_page_unmap failed %e\n", r);
  800ef4:	50                   	push   %eax
  800ef5:	68 a0 17 80 00       	push   $0x8017a0
  800efa:	6a 32                	push   $0x32
  800efc:	68 63 17 80 00       	push   $0x801763
  800f01:	e8 aa 01 00 00       	call   8010b0 <_panic>
...
fork(void)
{
  ...
  800f13:	68 31 0e 80 00       	push   $0x800e31
  800f18:	e8 dd 01 00 00       	call   8010fa <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800f24:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  800f2f:	78 2a                	js     800f5b <fork+0x55>
  ...
  800f31:	bb 00 00 00 00       	mov    $0x0,%ebx
    if (envid == 0) {
  800f36:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  800f3a:	75 63                	jne    800f9f <fork+0x99>
        envid_t my_envid = sys_getenvid();
  800f3c:	e8 ba fc ff ff       	call   800bfb <sys_getenvid>
        thisenv = &envs[ENVX(my_envid)];
  800f41:	25 ff 03 00 00       	and    $0x3ff,%eax
  800f46:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f49:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800f4e:	a3 04 20 80 00       	mov    %eax,0x802004
        return 0;
  800f53:	8b 45 e0             	mov    -0x20(%ebp),%eax
  800f56:	e9 2f 01 00 00       	jmp    80108a <fork+0x184>
        panic("fork, sys_exofork %e", envid);
  800f5b:	50                   	push   %eax
  800f5c:	68 ba 17 80 00       	push   $0x8017ba
  800f61:	68 82 00 00 00       	push   $0x82
  800f66:	68 63 17 80 00       	push   $0x801763
  800f6b:	e8 40 01 00 00       	call   8010b0 <_panic>
  ...
  800f80:	e8 03 fd ff ff       	call   800c88 <sys_page_map>
  800f85:	83 c4 20             	add    $0x20,%esp
  800f88:	85 c0                	test   %eax,%eax
  800f8a:	0f 88 90 00 00 00    	js     801020 <fork+0x11a>
        for (uint32_t pn = 0; pn < (USTACKTOP >> PGSHIFT); ++pn) {
  800f90:	83 c3 01             	add    $0x1,%ebx
  800f93:	81 fb fe eb 0e 00    	cmp    $0xeebfe,%ebx
  800f99:	0f 84 a5 00 00 00    	je     801044 <fork+0x13e>
  800f9f:	89 de                	mov    %ebx,%esi
  800fa1:	c1 e6 0c             	shl    $0xc,%esi
            uintptr_t pgaddr = pn << PGSHIFT;
            if ( (uvpd[PDX(pgaddr)] & PTE_P) &&
  800fa4:	89 f0                	mov    %esi,%eax
  800fa6:	c1 e8 16             	shr    $0x16,%eax
  800fa9:	8b 04 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%eax
  800fb0:	a8 01                	test   $0x1,%al
  800fb2:	74 dc                	je     800f90 <fork+0x8a>
                    (uvpt[pn] & PTE_P) ) {
  800fb4:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
            if ( (uvpd[PDX(pgaddr)] & PTE_P) &&
  800fbb:	a8 01                	test   $0x1,%al
  800fbd:	74 d1                	je     800f90 <fork+0x8a>
    pte_t pte = uvpt[pn];
  800fbf:	8b 04 9d 00 00 40 ef 	mov    -0x10c00000(,%ebx,4),%eax
    if ( pte & PTE_SHARE) {
  800fc6:	f6 c4 04             	test   $0x4,%ah
  800fc9:	75 a5                	jne    800f70 <fork+0x6a>
    if ( ((pte & PTE_W) || (pte & PTE_COW)) && !(pte & PTE_SHARE)) {
  800fcb:	25 02 08 00 00       	and    $0x802,%eax
        perm |= PTE_COW;
  800fd0:	83 f8 01             	cmp    $0x1,%eax
  800fd3:	19 ff                	sbb    %edi,%edi
  800fd5:	81 e7 00 f8 ff ff    	and    $0xfffff800,%edi
  800fdb:	81 c7 05 08 00 00    	add    $0x805,%edi
  ...
  800fec:	e8 97 fc ff ff       	call   800c88 <sys_page_map>
  800ff1:	83 c4 20             	add    $0x20,%esp
  800ff4:	85 c0                	test   %eax,%eax
  800ff6:	78 3a                	js     801032 <fork+0x12c>
  ...
  801002:	e8 81 fc ff ff       	call   800c88 <sys_page_map>
  801007:	83 c4 20             	add    $0x20,%esp
  80100a:	85 c0                	test   %eax,%eax
  80100c:	79 82                	jns    800f90 <fork+0x8a>
            panic("sys_page_map mine failed %e\n", r);
  80100e:	50                   	push   %eax
  80100f:	68 cf 17 80 00       	push   $0x8017cf
  801014:	6a 5d                	push   $0x5d
  801016:	68 63 17 80 00       	push   $0x801763
  80101b:	e8 90 00 00 00       	call   8010b0 <_panic>
    	    panic("sys_page_map others failed %e\n", r);
  801020:	50                   	push   %eax
  801021:	68 04 18 80 00       	push   $0x801804
  801026:	6a 4d                	push   $0x4d
  801028:	68 63 17 80 00       	push   $0x801763
  80102d:	e8 7e 00 00 00       	call   8010b0 <_panic>
        panic("sys_page_map others failed %e\n", r);
  801032:	50                   	push   %eax
  801033:	68 04 18 80 00       	push   $0x801804
  801038:	6a 58                	push   $0x58
  80103a:	68 63 17 80 00       	push   $0x801763
  80103f:	e8 6c 00 00 00       	call   8010b0 <_panic>
            }
        }
  ...
  80104e:	8b 7d e0             	mov    -0x20(%ebp),%edi
  801051:	57                   	push   %edi
  801052:	e8 ea fb ff ff       	call   800c41 <sys_page_alloc>
  801057:	83 c4 10             	add    $0x10,%esp
  80105a:	85 c0                	test   %eax,%eax
  80105c:	78 2c                	js     80108a <fork+0x184>
                    PTE_U | PTE_W | PTE_P)) < 0) {
            return r;
        }
  ...
  80105e:	a1 04 20 80 00       	mov    0x802004,%eax
        if ((r = sys_env_set_pgfault_upcall(envid,
  801063:	8b 40 64             	mov    0x64(%eax),%eax
  801066:	83 ec 08             	sub    $0x8,%esp
  801069:	50                   	push   %eax
  80106a:	57                   	push   %edi
  80106b:	e8 30 fd ff ff       	call   800da0 <sys_env_set_pgfault_upcall>
  801070:	83 c4 10             	add    $0x10,%esp
  801073:	85 c0                	test   %eax,%eax
  801075:	78 13                	js     80108a <fork+0x184>
            return r;
        }

        if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0) {
  801077:	83 ec 08             	sub    $0x8,%esp
  80107a:	6a 02                	push   $0x2
  80107c:	57                   	push   %edi
  80107d:	e8 92 fc ff ff       	call   800d14 <sys_env_set_status>
  801082:	83 c4 10             	add    $0x10,%esp
            return r;
        }
        return envid;
  801085:	85 c0                	test   %eax,%eax
  801087:	0f 49 c7             	cmovns %edi,%eax
    }
...
sfork(void)
{
  ...
  80109c:	68 ec 17 80 00       	push   $0x8017ec
  8010a1:	68 ac 00 00 00       	push   $0xac
  8010a6:	68 63 17 80 00       	push   $0x801763
  8010ab:	e8 00 00 00 00       	call   8010b0 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010b8:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  8010b9:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8010bc:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8010c2:	e8 34 fb ff ff       	call   800bfb <sys_getenvid>
  8010c7:	83 ec 0c             	sub    $0xc,%esp
  8010ca:	ff 75 0c             	pushl  0xc(%ebp)
  8010cd:	ff 75 08             	pushl  0x8(%ebp)
  8010d0:	56                   	push   %esi
  8010d1:	50                   	push   %eax
  8010d2:	68 24 18 80 00       	push   $0x801824
  8010d7:	e8 1a f1 ff ff       	call   8001f6 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8010dc:	83 c4 18             	add    $0x18,%esp
  8010df:	53                   	push   %ebx
  8010e0:	ff 75 10             	pushl  0x10(%ebp)
  8010e3:	e8 b9 f0 ff ff       	call   8001a1 <vcprintf>
	cprintf("\n");
  8010e8:	c7 04 24 0f 14 80 00 	movl   $0x80140f,(%esp)
  8010ef:	e8 02 f1 ff ff       	call   8001f6 <cprintf>
  8010f4:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  8010f7:	cc                   	int3   
  8010f8:	eb fd                	jmp    8010f7 <_panic+0x47>

008010fa <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801104:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  80110b:	74 0a                	je     801117 <set_pgfault_handler+0x1d>
        }
  ...
  801110:	a3 08 20 80 00       	mov    %eax,0x802008
}
  801115:	c9                   	leave  
  801116:	c3                   	ret    
        cprintf("UXSTACK alloc\n");
  801117:	83 ec 0c             	sub    $0xc,%esp
  80111a:	68 47 18 80 00       	push   $0x801847
  80111f:	e8 d2 f0 ff ff       	call   8001f6 <cprintf>
        if (sys_page_alloc(0, (void*)(UXSTACKTOP-PGSIZE), PTE_U | PTE_W | PTE_P) < 0) {
  801124:	83 c4 0c             	add    $0xc,%esp
  801127:	6a 07                	push   $0x7
  801129:	68 00 f0 bf ee       	push   $0xeebff000
  80112e:	6a 00                	push   $0x0
  801130:	e8 0c fb ff ff       	call   800c41 <sys_page_alloc>
  801135:	83 c4 10             	add    $0x10,%esp
  801138:	85 c0                	test   %eax,%eax
  80113a:	78 2a                	js     801166 <set_pgfault_handler+0x6c>
        if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0) {
  80113c:	83 ec 08             	sub    $0x8,%esp
  80113f:	68 7a 11 80 00       	push   $0x80117a
  801144:	6a 00                	push   $0x0
  801146:	e8 55 fc ff ff       	call   800da0 <sys_env_set_pgfault_upcall>
  80114b:	83 c4 10             	add    $0x10,%esp
  80114e:	85 c0                	test   %eax,%eax
  801150:	79 bb                	jns    80110d <set_pgfault_handler+0x13>
            panic("sys_env_set_pgfault_upcall failed!");
  801152:	83 ec 04             	sub    $0x4,%esp
  801155:	68 84 18 80 00       	push   $0x801884
  80115a:	6a 25                	push   $0x25
  80115c:	68 74 18 80 00       	push   $0x801874
  801161:	e8 4a ff ff ff       	call   8010b0 <_panic>
            panic("Allocation of UXSTACK failed!");
  801166:	83 ec 04             	sub    $0x4,%esp
  801169:	68 56 18 80 00       	push   $0x801856
  80116e:	6a 22                	push   $0x22
  801170:	68 74 18 80 00       	push   $0x801874
  801175:	e8 36 ff ff ff       	call   8010b0 <_panic>

0080117a <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  80117b:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  801182:	83 c4 04             	add    $0x4,%esp
    ...
    mov 40(%esp), %ebp
  801185:	8b 6c 24 28          	mov    0x28(%esp),%ebp
    // load trap-time esp to edi
    mov 48(%esp), %edi
  801189:	8b 7c 24 30          	mov    0x30(%esp),%edi
    // push trap-time eip to trap-time esp
    mov %ebp, -4(%edi)
  80118d:	89 6f fc             	mov    %ebp,-0x4(%edi)
  ...
  801197:	9d                   	popf   
	...
	// LAB 4: Your code here.
    mov (%esp), %esp
  801198:	8b 24 24             	mov    (%esp),%esp

	// Return to re-execute the instruction that faulted.
	// LAB 4: Your code here.
    lea -4(%esp), %esp
  80119b:	8d 64 24 fc          	lea    -0x4(%esp),%esp
    ret
  80119f:	c3                   	ret    
