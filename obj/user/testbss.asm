...
libmain(int argc, char **argv)
{
  ...
  8000ef:	e8 38 0b 00 00       	call   800c2c <sys_getenvid>
...
exit(void)
{
  ...
  800136:	e8 ac 0a 00 00       	call   800be7 <sys_env_destroy>
}
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800152:	e8 d5 0a 00 00       	call   800c2c <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001c1:	50                   	push   %eax
  8001c2:	e8 db 09 00 00       	call   800ba2 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800219:	50                   	push   %eax
  80021a:	e8 83 09 00 00       	call   800ba2 <sys_cputs>
...
0080032a <vprintfmt>:
{
  ...
  800340:	e9 4a 03 00 00       	jmp    80068f <vprintfmt+0x365>
		padc = ' ';
  ...
  800371:	0f 87 de 03 00 00    	ja     800755 <vprintfmt+0x42b>
  ...
  80042d:	89 7d 14             	mov    %edi,0x14(%ebp)
			break;
  800430:	e9 57 02 00 00       	jmp    80068c <vprintfmt+0x362>
			err = va_arg(ap, int);
  ...
  800465:	e9 22 02 00 00       	jmp    80068c <vprintfmt+0x362>
  ...
  80047a:	89 7d 14             	mov    %edi,0x14(%ebp)
				printfmt(putch, putdat, "error %d", err);
  80047d:	e9 0a 02 00 00       	jmp    80068c <vprintfmt+0x362>
  ...
  8004bf:	e8 45 03 00 00       	call   800809 <strnlen>
  ...
  800564:	e9 23 01 00 00       	jmp    80068c <vprintfmt+0x362>
  ...
  8005b1:	0f 89 bb 00 00 00    	jns    800672 <vprintfmt+0x348>
				putch('-', putdat);
  ...
  8005d4:	e9 99 00 00 00       	jmp    800672 <vprintfmt+0x348>
  ...
  8005f3:	7f 1b                	jg     800610 <vprintfmt+0x2e6>
	else if (lflag)
  8005f5:	85 c9                	test   %ecx,%ecx
  8005f7:	74 2c                	je     800625 <vprintfmt+0x2fb>
  ...
  800609:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned long);
  80060e:	eb 62                	jmp    800672 <vprintfmt+0x348>
  ...
  80061e:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned long long);
  800623:	eb 4d                	jmp    800672 <vprintfmt+0x348>
  ...
  800635:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned int);
  80063a:	eb 36                	jmp    800672 <vprintfmt+0x348>
	if (lflag >= 2)
  80063c:	83 f9 01             	cmp    $0x1,%ecx
  80063f:	7f 17                	jg     800658 <vprintfmt+0x32e>
	else if (lflag)
  800641:	85 c9                	test   %ecx,%ecx
  800643:	74 6e                	je     8006b3 <vprintfmt+0x389>
		return va_arg(*ap, long);
  ...
  80067e:	51                   	push   %ecx
  80067f:	52                   	push   %edx
  800680:	89 da                	mov    %ebx,%edx
  800682:	89 f0                	mov    %esi,%eax
  800684:	e8 b6 fb ff ff       	call   80023f <printnum>
			break;
  ...
  800699:	0f 84 a6 fc ff ff    	je     800345 <vprintfmt+0x1b>
			if (ch == '\0')
  80069f:	85 c0                	test   %eax,%eax
  8006a1:	0f 84 ce 00 00 00    	je     800775 <vprintfmt+0x44b>
			putch(ch, putdat);
  ...
  8006b1:	eb dc                	jmp    80068f <vprintfmt+0x365>
		return va_arg(*ap, int);
  ...
  8006c4:	eb a3                	jmp    800669 <vprintfmt+0x33f>
			putch('0', putdat);
  ...
  8006e9:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8006ee:	eb 82                	jmp    800672 <vprintfmt+0x348>
	if (lflag >= 2)
  8006f0:	83 f9 01             	cmp    $0x1,%ecx
  8006f3:	7f 1e                	jg     800713 <vprintfmt+0x3e9>
	else if (lflag)
  8006f5:	85 c9                	test   %ecx,%ecx
  8006f7:	74 32                	je     80072b <vprintfmt+0x401>
		return va_arg(*ap, unsigned long);
  ...
  800709:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned long);
  80070e:	e9 5f ff ff ff       	jmp    800672 <vprintfmt+0x348>
		return va_arg(*ap, unsigned long long);
  ...
  800721:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned long long);
  800726:	e9 47 ff ff ff       	jmp    800672 <vprintfmt+0x348>
		return va_arg(*ap, unsigned int);
  ...
  80073b:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned int);
  800740:	e9 2d ff ff ff       	jmp    800672 <vprintfmt+0x348>
			putch(ch, putdat);
  ...
  800750:	e9 37 ff ff ff       	jmp    80068c <vprintfmt+0x362>
			putch('%', putdat);
  ...
  800766:	74 05                	je     80076d <vprintfmt+0x443>
  800768:	83 e8 01             	sub    $0x1,%eax
  80076b:	eb f5                	jmp    800762 <vprintfmt+0x438>
  80076d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800770:	e9 17 ff ff ff       	jmp    80068c <vprintfmt+0x362>
}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  8007af:	50                   	push   %eax
  8007b0:	68 e8 02 80 00       	push   $0x8002e8
  8007b5:	e8 70 fb ff ff       	call   80032a <vprintfmt>
...
sys_env_destroy(envid_t envid)
{
  ...
  800c1b:	68 e4 13 80 00       	push   $0x8013e4
  800c20:	6a 23                	push   $0x23
  800c22:	68 01 14 80 00       	push   $0x801401
  800c27:	e8 14 f5 ff ff       	call   800140 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca8:	68 e4 13 80 00       	push   $0x8013e4
  800cad:	6a 23                	push   $0x23
  800caf:	68 01 14 80 00       	push   $0x801401
  800cb4:	e8 87 f4 ff ff       	call   800140 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cee:	68 e4 13 80 00       	push   $0x8013e4
  800cf3:	6a 23                	push   $0x23
  800cf5:	68 01 14 80 00       	push   $0x801401
  800cfa:	e8 41 f4 ff ff       	call   800140 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d34:	68 e4 13 80 00       	push   $0x8013e4
  800d39:	6a 23                	push   $0x23
  800d3b:	68 01 14 80 00       	push   $0x801401
  800d40:	e8 fb f3 ff ff       	call   800140 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d7a:	68 e4 13 80 00       	push   $0x8013e4
  800d7f:	6a 23                	push   $0x23
  800d81:	68 01 14 80 00       	push   $0x801401
  800d86:	e8 b5 f3 ff ff       	call   800140 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800db0:	7f 08                	jg     800dba <sys_env_set_pgfault_upcall+0x2f>
  ...
  800dc0:	68 e4 13 80 00       	push   $0x8013e4
  800dc5:	6a 23                	push   $0x23
  800dc7:	68 01 14 80 00       	push   $0x801401
  800dcc:	e8 6f f3 ff ff       	call   800140 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e1c:	7f 08                	jg     800e26 <sys_ipc_recv+0x2e>
  ...
  800e29:	50                   	push   %eax
  800e2a:	6a 0c                	push   $0xc
  800e2c:	68 e4 13 80 00       	push   $0x8013e4
  800e31:	6a 23                	push   $0x23
  800e33:	68 01 14 80 00       	push   $0x801401
  800e38:	e8 03 f3 ff ff       	call   800140 <_panic>
