...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003d:	c7 05 00 30 80 00 c0 	movl   $0x801ec0,0x803000
  800044:	1e 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800139:	68 cf 1e 80 00       	push   $0x801ecf
  80013e:	6a 23                	push   $0x23
  800140:	68 ec 1e 80 00       	push   $0x801eec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001c6:	68 cf 1e 80 00       	push   $0x801ecf
  8001cb:	6a 23                	push   $0x23
  8001cd:	68 ec 1e 80 00       	push   $0x801eec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80020c:	68 cf 1e 80 00       	push   $0x801ecf
  800211:	6a 23                	push   $0x23
  800213:	68 ec 1e 80 00       	push   $0x801eec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800252:	68 cf 1e 80 00       	push   $0x801ecf
  800257:	6a 23                	push   $0x23
  800259:	68 ec 1e 80 00       	push   $0x801eec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800298:	68 cf 1e 80 00       	push   $0x801ecf
  80029d:	6a 23                	push   $0x23
  80029f:	68 ec 1e 80 00       	push   $0x801eec
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002de:	68 cf 1e 80 00       	push   $0x801ecf
  8002e3:	6a 23                	push   $0x23
  8002e5:	68 ec 1e 80 00       	push   $0x801eec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800324:	68 cf 1e 80 00       	push   $0x801ecf
  800329:	6a 23                	push   $0x23
  80032b:	68 ec 1e 80 00       	push   $0x801eec
...
sys_ipc_recv(void *dstva)
{
  ...
  800390:	68 cf 1e 80 00       	push   $0x801ecf
  800395:	6a 23                	push   $0x23
  800397:	68 ec 1e 80 00       	push   $0x801eec
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800487:	ba 78 1f 80 00       	mov    $0x801f78,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8004a9:	51                   	push   %ecx
  8004aa:	50                   	push   %eax
  8004ab:	68 fc 1e 80 00       	push   $0x801efc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800717:	53                   	push   %ebx
  800718:	50                   	push   %eax
  800719:	68 3d 1f 80 00       	push   $0x801f3d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007e8:	53                   	push   %ebx
  8007e9:	50                   	push   %eax
  8007ea:	68 59 1f 80 00       	push   $0x801f59
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800898:	53                   	push   %ebx
  800899:	50                   	push   %eax
  80089a:	68 1c 1f 80 00       	push   $0x801f1c
...
00800a6e <devfile_write>:
{
  ...
  800a78:	68 88 1f 80 00       	push   $0x801f88
  800a7d:	68 90 00 00 00       	push   $0x90
  800a82:	68 a6 1f 80 00       	push   $0x801fa6
...
00800a8c <devfile_read>:
{
  ...
  800ae5:	c3                   	ret    
	assert(r <= n);
  800ae6:	68 b1 1f 80 00       	push   $0x801fb1
  800aeb:	68 b8 1f 80 00       	push   $0x801fb8
  800af0:	6a 7c                	push   $0x7c
  800af2:	68 a6 1f 80 00       	push   $0x801fa6
  800af7:	e8 be 05 00 00       	call   8010ba <_panic>
	assert(r <= PGSIZE);
  800afc:	68 cd 1f 80 00       	push   $0x801fcd
  800b01:	68 b8 1f 80 00       	push   $0x801fb8
  800b06:	6a 7d                	push   $0x7d
  800b08:	68 a6 1f 80 00       	push   $0x801fa6
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bdb:	68 d9 1f 80 00       	push   $0x801fd9
  800be0:	53                   	push   %ebx
...
00800c3f <_pipeisclosed>:
{
  ...
  800c82:	50                   	push   %eax
  800c83:	53                   	push   %ebx
  800c84:	68 e0 1f 80 00       	push   $0x801fe0
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f39:	68 f8 1f 80 00       	push   $0x801ff8
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010da:	56                   	push   %esi
  8010db:	50                   	push   %eax
  8010dc:	68 04 20 80 00       	push   $0x802004
  ...
  8010ed:	e8 5a 00 00 00       	call   80114c <vcprintf>
	cprintf("\n");
  8010f2:	c7 04 24 f1 1f 80 00 	movl   $0x801ff1,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80124d:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  801254:	50                   	push   %eax
...
008012a4 <vprintfmt>:
{
  ...
  8013cc:	52                   	push   %edx
  8013cd:	68 ca 1f 80 00       	push   $0x801fca
  8013d2:	53                   	push   %ebx
  8013d3:	56                   	push   %esi
  ...
  8013e4:	50                   	push   %eax
  8013e5:	68 3f 20 80 00       	push   $0x80203f
  8013ea:	53                   	push   %ebx
  8013eb:	56                   	push   %esi
  ...
  80140c:	b8 38 20 80 00       	mov    $0x802038,%eax
