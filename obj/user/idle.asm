...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003d:	c7 05 00 20 80 00 20 	movl   $0x801020,0x802000
  800044:	10 80 00 
	...
	while (1) {
		sys_yield();
  800047:	e8 0f 01 00 00       	call   80015b <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800127:	68 2f 10 80 00       	push   $0x80102f
  80012c:	6a 23                	push   $0x23
  80012e:	68 4c 10 80 00       	push   $0x80104c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b4:	68 2f 10 80 00       	push   $0x80102f
  8001b9:	6a 23                	push   $0x23
  8001bb:	68 4c 10 80 00       	push   $0x80104c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001fa:	68 2f 10 80 00       	push   $0x80102f
  8001ff:	6a 23                	push   $0x23
  800201:	68 4c 10 80 00       	push   $0x80104c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800240:	68 2f 10 80 00       	push   $0x80102f
  800245:	6a 23                	push   $0x23
  800247:	68 4c 10 80 00       	push   $0x80104c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800286:	68 2f 10 80 00       	push   $0x80102f
  80028b:	6a 23                	push   $0x23
  80028d:	68 4c 10 80 00       	push   $0x80104c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002cc:	68 2f 10 80 00       	push   $0x80102f
  8002d1:	6a 23                	push   $0x23
  8002d3:	68 4c 10 80 00       	push   $0x80104c
...
sys_ipc_recv(void *dstva)
{
  ...
  800338:	68 2f 10 80 00       	push   $0x80102f
  80033d:	6a 23                	push   $0x23
  80033f:	68 4c 10 80 00       	push   $0x80104c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800369:	56                   	push   %esi
  80036a:	50                   	push   %eax
  80036b:	68 5c 10 80 00       	push   $0x80105c
  ...
  80037c:	e8 5a 00 00 00       	call   8003db <vcprintf>
	cprintf("\n");
  800381:	c7 04 24 7f 10 80 00 	movl   $0x80107f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004dc:	0f be 80 81 10 80 00 	movsbl 0x801081(%eax),%eax
  8004e3:	50                   	push   %eax
...
00800533 <vprintfmt>:
{
  ...
  800549:	e9 4a 03 00 00       	jmp    800898 <vprintfmt+0x365>
		padc = ' ';
  ...
  80057a:	0f 87 de 03 00 00    	ja     80095e <vprintfmt+0x42b>
  ...
  800636:	89 7d 14             	mov    %edi,0x14(%ebp)
			break;
  800639:	e9 57 02 00 00       	jmp    800895 <vprintfmt+0x362>
			err = va_arg(ap, int);
  ...
  80065b:	52                   	push   %edx
  80065c:	68 a2 10 80 00       	push   $0x8010a2
  800661:	53                   	push   %ebx
  800662:	56                   	push   %esi
  ...
  80066e:	e9 22 02 00 00       	jmp    800895 <vprintfmt+0x362>
				printfmt(putch, putdat, "error %d", err);
  800673:	50                   	push   %eax
  800674:	68 99 10 80 00       	push   $0x801099
  800679:	53                   	push   %ebx
  80067a:	56                   	push   %esi
  ...
  800683:	89 7d 14             	mov    %edi,0x14(%ebp)
				printfmt(putch, putdat, "error %d", err);
  800686:	e9 0a 02 00 00       	jmp    800895 <vprintfmt+0x362>
  ...
  80069b:	b8 92 10 80 00       	mov    $0x801092,%eax
  ...
  8006c8:	e8 45 03 00 00       	call   800a12 <strnlen>
  ...
  80076d:	e9 23 01 00 00       	jmp    800895 <vprintfmt+0x362>
  ...
  8007ba:	0f 89 bb 00 00 00    	jns    80087b <vprintfmt+0x348>
				putch('-', putdat);
  ...
  8007dd:	e9 99 00 00 00       	jmp    80087b <vprintfmt+0x348>
  ...
  8007fc:	7f 1b                	jg     800819 <vprintfmt+0x2e6>
	else if (lflag)
  8007fe:	85 c9                	test   %ecx,%ecx
  800800:	74 2c                	je     80082e <vprintfmt+0x2fb>
  ...
  800812:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned long);
  800817:	eb 62                	jmp    80087b <vprintfmt+0x348>
  ...
  800827:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned long long);
  80082c:	eb 4d                	jmp    80087b <vprintfmt+0x348>
  ...
  80083e:	b8 0a 00 00 00       	mov    $0xa,%eax
		return va_arg(*ap, unsigned int);
  800843:	eb 36                	jmp    80087b <vprintfmt+0x348>
	if (lflag >= 2)
  800845:	83 f9 01             	cmp    $0x1,%ecx
  800848:	7f 17                	jg     800861 <vprintfmt+0x32e>
	else if (lflag)
  80084a:	85 c9                	test   %ecx,%ecx
  80084c:	74 6e                	je     8008bc <vprintfmt+0x389>
		return va_arg(*ap, long);
  80084e:	8b 45 14             	mov    0x14(%ebp),%eax
  800851:	8b 10                	mov    (%eax),%edx
  800853:	89 d0                	mov    %edx,%eax
  800855:	99                   	cltd   
  800856:	8b 4d 14             	mov    0x14(%ebp),%ecx
  800859:	8d 49 04             	lea    0x4(%ecx),%ecx
  80085c:	89 4d 14             	mov    %ecx,0x14(%ebp)
  80085f:	eb 11                	jmp    800872 <vprintfmt+0x33f>
		return va_arg(*ap, long long);
  800861:	8b 45 14             	mov    0x14(%ebp),%eax
  800864:	8b 50 04             	mov    0x4(%eax),%edx
  800867:	8b 00                	mov    (%eax),%eax
  800869:	8b 4d 14             	mov    0x14(%ebp),%ecx
  80086c:	8d 49 08             	lea    0x8(%ecx),%ecx
  80086f:	89 4d 14             	mov    %ecx,0x14(%ebp)
			num = getint(&ap, lflag);
  ...
  80087e:	0f be 7d d3          	movsbl -0x2d(%ebp),%edi
  800882:	57                   	push   %edi
  ...
  80088d:	e8 b6 fb ff ff       	call   800448 <printnum>
			break;
  ...
  80089b:	0f b6 47 ff          	movzbl -0x1(%edi),%eax
  80089f:	83 f8 25             	cmp    $0x25,%eax
  8008a2:	0f 84 a6 fc ff ff    	je     80054e <vprintfmt+0x1b>
			if (ch == '\0')
  8008a8:	85 c0                	test   %eax,%eax
  8008aa:	0f 84 ce 00 00 00    	je     80097e <vprintfmt+0x44b>
			putch(ch, putdat);
  ...
  8008ba:	eb dc                	jmp    800898 <vprintfmt+0x365>
		return va_arg(*ap, int);
  8008bc:	8b 45 14             	mov    0x14(%ebp),%eax
  8008bf:	8b 10                	mov    (%eax),%edx
  8008c1:	89 d0                	mov    %edx,%eax
  8008c3:	99                   	cltd   
  8008c4:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8008c7:	8d 49 04             	lea    0x4(%ecx),%ecx
  8008ca:	89 4d 14             	mov    %ecx,0x14(%ebp)
  8008cd:	eb a3                	jmp    800872 <vprintfmt+0x33f>
			putch('0', putdat);
  8008cf:	83 ec 08             	sub    $0x8,%esp
  8008d2:	53                   	push   %ebx
  8008d3:	6a 30                	push   $0x30
  8008d5:	ff d6                	call   *%esi
			putch('x', putdat);
  8008d7:	83 c4 08             	add    $0x8,%esp
  8008da:	53                   	push   %ebx
  8008db:	6a 78                	push   $0x78
  ...
  8008f2:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8008f7:	eb 82                	jmp    80087b <vprintfmt+0x348>
	if (lflag >= 2)
  8008f9:	83 f9 01             	cmp    $0x1,%ecx
  8008fc:	7f 1e                	jg     80091c <vprintfmt+0x3e9>
	else if (lflag)
  8008fe:	85 c9                	test   %ecx,%ecx
  800900:	74 32                	je     800934 <vprintfmt+0x401>
		return va_arg(*ap, unsigned long);
  ...
  800912:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned long);
  800917:	e9 5f ff ff ff       	jmp    80087b <vprintfmt+0x348>
		return va_arg(*ap, unsigned long long);
  ...
  80092a:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned long long);
  80092f:	e9 47 ff ff ff       	jmp    80087b <vprintfmt+0x348>
		return va_arg(*ap, unsigned int);
  ...
  800944:	b8 10 00 00 00       	mov    $0x10,%eax
		return va_arg(*ap, unsigned int);
  800949:	e9 2d ff ff ff       	jmp    80087b <vprintfmt+0x348>
			putch(ch, putdat);
  ...
  800959:	e9 37 ff ff ff       	jmp    800895 <vprintfmt+0x362>
			putch('%', putdat);
  ...
  80096b:	80 78 ff 25          	cmpb   $0x25,-0x1(%eax)
  80096f:	74 05                	je     800976 <vprintfmt+0x443>
  800971:	83 e8 01             	sub    $0x1,%eax
  800974:	eb f5                	jmp    80096b <vprintfmt+0x438>
  800976:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800979:	e9 17 ff ff ff       	jmp    800895 <vprintfmt+0x362>
}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  800996:	89 45 ec             	mov    %eax,-0x14(%ebp)
  800999:	8d 4c 10 ff          	lea    -0x1(%eax,%edx,1),%ecx
  80099d:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  8009a0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	if (buf == NULL || n < 1)
  8009a7:	85 c0                	test   %eax,%eax
  8009a9:	74 26                	je     8009d1 <vsnprintf+0x4b>
  8009ab:	85 d2                	test   %edx,%edx
  8009ad:	7e 22                	jle    8009d1 <vsnprintf+0x4b>
		return -E_INVAL;
  ...
  8009b8:	50                   	push   %eax
  8009b9:	68 f1 04 80 00       	push   $0x8004f1
  8009be:	e8 70 fb ff ff       	call   800533 <vprintfmt>
  ...
  8009d6:	eb f7                	jmp    8009cf <vsnprintf+0x49>
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  8009ef:	e8 92 ff ff ff       	call   800986 <vsnprintf>
	va_end(ap);
...
strlen(const char *s)
{
  ...
  800a05:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
  800a09:	74 05                	je     800a10 <strlen+0x1a>
		n++;
  800a0b:	83 c0 01             	add    $0x1,%eax
  800a0e:	eb f5                	jmp    800a05 <strlen+0xf>
	return n;
}
  800a10:	5d                   	pop    %ebp
  800a11:	c3                   	ret    
...
strnlen(const char *s, size_t size)
{
  ...
  800a26:	74 0d                	je     800a35 <strnlen+0x23>
  800a28:	80 3c 01 00          	cmpb   $0x0,(%ecx,%eax,1)
  800a2c:	74 05                	je     800a33 <strnlen+0x21>
		n++;
  800a2e:	83 c0 01             	add    $0x1,%eax
  800a31:	eb f1                	jmp    800a24 <strnlen+0x12>
...
strcpy(char *dst, const char *src)
{
  ...
  800a4c:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
  800a50:	88 14 01             	mov    %dl,(%ecx,%eax,1)
  800a53:	83 c0 01             	add    $0x1,%eax
  800a56:	84 d2                	test   %dl,%dl
  800a58:	75 f2                	jne    800a4c <strcpy+0x13>
		/* do nothing */;
	return ret;
}
  800a5a:	89 c8                	mov    %ecx,%eax
  800a5c:	5b                   	pop    %ebx
  800a5d:	5d                   	pop    %ebp
  800a5e:	c3                   	ret    
...
strcat(char *dst, const char *src)
{
  ...
  800a66:	53                   	push   %ebx
  800a67:	83 ec 10             	sub    $0x10,%esp
  800a6a:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int len = strlen(dst);
  800a6d:	53                   	push   %ebx
  800a6e:	e8 83 ff ff ff       	call   8009f6 <strlen>
  800a73:	83 c4 08             	add    $0x8,%esp
	strcpy(dst + len, src);
  800a76:	ff 75 0c             	pushl  0xc(%ebp)
  800a79:	01 d8                	add    %ebx,%eax
  800a7b:	50                   	push   %eax
  800a7c:	e8 b8 ff ff ff       	call   800a39 <strcpy>
	return dst;
}
...
strncpy(char *dst, const char *src, size_t size) {
  ...
  800aa0:	74 11                	je     800ab3 <strncpy+0x2b>
		*dst++ = *src;
  800aa2:	83 c0 01             	add    $0x1,%eax
  800aa5:	0f b6 0a             	movzbl (%edx),%ecx
  800aa8:	88 48 ff             	mov    %cl,-0x1(%eax)
		// If strlen(src) < size, null-pad 'dst' out to 'size' chars
		if (*src != '\0')
			src++;
  800aab:	80 f9 01             	cmp    $0x1,%cl
  800aae:	83 da ff             	sbb    $0xffffffff,%edx
  800ab1:	eb eb                	jmp    800a9e <strncpy+0x16>
	}
	return ret;
}
...
strcmp(const char *p, const char *q)
{
  ...
  800b0a:	74 0c                	je     800b18 <strcmp+0x20>
  800b0c:	3a 02                	cmp    (%edx),%al
  800b0e:	75 08                	jne    800b18 <strcmp+0x20>
		p++, q++;
  800b10:	83 c1 01             	add    $0x1,%ecx
  800b13:	83 c2 01             	add    $0x1,%edx
  800b16:	eb ed                	jmp    800b05 <strcmp+0xd>
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  800b32:	03 5d 10             	add    0x10(%ebp),%ebx
	while (n > 0 && *p && *p == *q)
  800b35:	eb 06                	jmp    800b3d <strncmp+0x1b>
		n--, p++, q++;
  800b37:	83 c0 01             	add    $0x1,%eax
  800b3a:	83 c2 01             	add    $0x1,%edx
	while (n > 0 && *p && *p == *q)
  800b3d:	39 d8                	cmp    %ebx,%eax
  800b3f:	74 16                	je     800b57 <strncmp+0x35>
  800b41:	0f b6 08             	movzbl (%eax),%ecx
  800b44:	84 c9                	test   %cl,%cl
  800b46:	74 04                	je     800b4c <strncmp+0x2a>
  800b48:	3a 0a                	cmp    (%edx),%cl
  800b4a:	74 eb                	je     800b37 <strncmp+0x15>
	if (n == 0)
		return 0;
	else
		return (int) ((unsigned char) *p - (unsigned char) *q);
  800b4c:	0f b6 00             	movzbl (%eax),%eax
  ...
  800b5c:	eb f6                	jmp    800b54 <strncmp+0x32>
...
strchr(const char *s, char c)
{
  ...
  800b71:	74 09                	je     800b7c <strchr+0x1e>
		if (*s == c)
  800b73:	38 ca                	cmp    %cl,%dl
  800b75:	74 0a                	je     800b81 <strchr+0x23>
	for (; *s; s++)
  800b77:	83 c0 01             	add    $0x1,%eax
  800b7a:	eb f0                	jmp    800b6c <strchr+0xe>
			return (char *) s;
	return 0;
...
strfind(const char *s, char c)
{
  ...
  800b96:	74 09                	je     800ba1 <strfind+0x1e>
  800b98:	84 d2                	test   %dl,%dl
  800b9a:	74 05                	je     800ba1 <strfind+0x1e>
	for (; *s; s++)
  800b9c:	83 c0 01             	add    $0x1,%eax
  800b9f:	eb f0                	jmp    800b91 <strfind+0xe>
			break;
	return (char *) s;
}
  800ba1:	5d                   	pop    %ebp
...
memset(void *v, int c, size_t n)
{
  ...
  800be0:	eb 06                	jmp    800be8 <memset+0x45>
			: "cc", "memory");
	} else
...
memmove(void *dst, const void *src, size_t n)
{
  ...
  800c03:	73 32                	jae    800c37 <memmove+0x48>
  800c05:	8d 14 0e             	lea    (%esi,%ecx,1),%edx
  800c08:	39 c2                	cmp    %eax,%edx
  800c0a:	76 2b                	jbe    800c37 <memmove+0x48>
		s += n;
		d += n;
  ...
  800c1b:	75 0e                	jne    800c2b <memmove+0x3c>
  ...
  800c29:	eb 09                	jmp    800c34 <memmove+0x45>
		else
  ...
  800c32:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
		...
		asm volatile("cld" ::: "cc");
  800c34:	fc                   	cld    
  800c35:	eb 1a                	jmp    800c51 <memmove+0x62>
	} else {
		if ((int)s%4 == 0 && (int)d%4 == 0 && n%4 == 0)
  ...
  800c40:	75 0a                	jne    800c4c <memmove+0x5d>
  ...
  800c4a:	eb 05                	jmp    800c51 <memmove+0x62>
		else
...
memcpy(void *dst, const void *src, size_t n)
{
  ...
  800c68:	e8 82 ff ff ff       	call   800bef <memmove>
}
  800c6d:	c9                   	leave  
  800c6e:	c3                   	ret    
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  800c80:	03 75 10             	add    0x10(%ebp),%esi
	const uint8_t *s1 = (const uint8_t *) v1;
	const uint8_t *s2 = (const uint8_t *) v2;

	while (n-- > 0) {
  800c83:	39 f0                	cmp    %esi,%eax
  800c85:	74 1c                	je     800ca3 <memcmp+0x34>
		if (*s1 != *s2)
  800c87:	0f b6 08             	movzbl (%eax),%ecx
  800c8a:	0f b6 1a             	movzbl (%edx),%ebx
  800c8d:	38 d9                	cmp    %bl,%cl
  800c8f:	75 08                	jne    800c99 <memcmp+0x2a>
			return (int) *s1 - (int) *s2;
		s1++, s2++;
  800c91:	83 c0 01             	add    $0x1,%eax
  800c94:	83 c2 01             	add    $0x1,%edx
  800c97:	eb ea                	jmp    800c83 <memcmp+0x14>
			return (int) *s1 - (int) *s2;
  800c99:	0f b6 c1             	movzbl %cl,%eax
  800c9c:	0f b6 db             	movzbl %bl,%ebx
  800c9f:	29 d8                	sub    %ebx,%eax
  800ca1:	eb 05                	jmp    800ca8 <memcmp+0x39>
	}
...
memfind(const void *s, int c, size_t n)
{
  ...
  800cc0:	73 09                	jae    800ccb <memfind+0x1f>
		if (*(const unsigned char *) s == (unsigned char) c)
  800cc2:	38 08                	cmp    %cl,(%eax)
  800cc4:	74 05                	je     800ccb <memfind+0x1f>
	for (; s < ends; s++)
  800cc6:	83 c0 01             	add    $0x1,%eax
  800cc9:	eb f3                	jmp    800cbe <memfind+0x12>
			break;
	return (void *) s;
}
  800ccb:	5d                   	pop    %ebp
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800d56:	7d 3a                	jge    800d92 <strtol+0xc5>
			break;
		s++, val = (val * base) + dig;
