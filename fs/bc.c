...
bc_pgfault(struct UTrapframe *utf)
{
	...
	if ((r = sys_page_alloc(0, round, PTE_W | PTE_U | PTE_P)) < 0) panic("in bc_pgfault, sys_page_alloc: %e", r);
	if ((r = ide_read(blockno*BLKSECTS, round, BLKSECTS)) < 0) panic("in bc_pgfault, ide_read: %e", r);
